...
%
function [] = one_dim_har_ocs_with_ac_field_ioniz_prob
clc; 
format short
%
...
%%%%%%%%%%%%%%%%%%%%%%%%
fileID_save_data_1 = fopen('one_dim_har_ocs_with_ac_field_ioniz_prob.txt','w');
%%% time loop starts ---
for i = 1:time_iter
    t(i) = i*dt;
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
read_popul_data = fopen('one_dim_har_ocs_with_ac_field_ioniz_prob.txt', 'r');               % 
